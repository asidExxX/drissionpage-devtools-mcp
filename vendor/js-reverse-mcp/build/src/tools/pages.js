        ...
        switch (request.params.type) {
            case 'url':
                ...
                try {
                    ...
                    response.appendResponseLine('Note: Any previously obtained script IDs are now invalid. Use script URLs instead.');
                }
                catch (error) {
                    if (debugger_.isPaused()) {
                        response.appendResponseLine(`Navigation to ${request.params.url} started but execution is paused at a breakpoint. Use get_paused_info to inspect, then resume to continue loading.`);
                    }
                    else {
            ...
            case 'back':
                try {
                    ...
                    if (debugger_.isPaused()) {
                        response.appendResponseLine(`Navigation back started but execution is paused at a breakpoint. Use get_paused_info to inspect, then resume to continue loading.`);
                    }
                    else {
            ...
            case 'forward':
                try {
                    ...
                    if (debugger_.isPaused()) {
                        response.appendResponseLine(`Navigation forward started but execution is paused at a breakpoint. Use get_paused_info to inspect, then resume to continue loading.`);
                    }
                    else {
            ...
            case 'reload':
                try {
                    ...
                    if (debugger_.isPaused()) {
                        response.appendResponseLine(`Page reload started but execution is paused at a breakpoint. Use get_paused_info to inspect, then resume to continue loading.`);
                    }
                    else {
